      ...
      <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p class="text-xs text-amber-700 mt-1">
            ER Tables can only be created for requirements that have been approved by both BA and Customer.
            Each table tracks its related DFD Data Store and approved requirements.
          </p>
        </div>
      </div>
...
export class ErListComponent implements OnInit {
  ...
  tables = signal([
    { id: '1', tableName: 'users', displayName: 'Users', columnCount: 8, relatedDfdDataStore: 'User DB', status: 'APPROVED' },
    { id: '2', tableName: 'orders', displayName: 'Orders', columnCount: 12, relatedDfdDataStore: 'Order DB', status: 'REVIEW' },
    { id: '3', tableName: 'products', displayName: 'Products', columnCount: 10, relatedDfdDataStore: 'Product DB', status: 'DRAFT' },
    { id: '4', tableName: 'customers', displayName: 'Customers', columnCount: 15, relatedDfdDataStore: 'Customer DB', status: 'APPROVED' },
  ]);
