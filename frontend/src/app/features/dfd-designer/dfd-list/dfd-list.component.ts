      ...
      <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p class="text-xs text-amber-700 mt-1">
            DFD processes can only be created for requirements that have been approved by both BA and Customer.
            Unapproved requirements will be blocked at creation time.
          </p>
        </div>
      </div>
...
export class DfdListComponent implements OnInit {
  ...
  processes = signal([
    { id: '1', processCode: 'P-001', processName: 'User Authentication', dfdLevel: 'Level 0', status: 'APPROVED', owner: 'SA_Pranee', inputData: 'Credentials', outputData: 'Session Token' },
    { id: '2', processCode: 'P-002', processName: 'Order Processing', dfdLevel: 'Level 1', status: 'REVIEW', owner: 'SA_Pranee', inputData: 'Order Data', outputData: 'Invoice' },
    { id: '3', processCode: 'P-003', processName: 'Report Generation', dfdLevel: 'Level 1', status: 'DRAFT', owner: 'SA_Somsak', inputData: 'Filter Criteria', outputData: 'PDF Report' },
  ]);
