...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/projects/project-timeline/project-timeline.component').then(
            (m) => m.ProjectTimelineComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/requirements/requirement-list/requirement-list.component').then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/dfd-designer/dfd-list/dfd-list.component').then(
            (m) => m.DfdListComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/specifications/spec-list/spec-list.component').then(
            (m) => m.SpecListComponent,
          ),
